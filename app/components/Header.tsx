...
const MENU = [
  {
    ...
    color: "#D8C8E4",
    external: true,
    link: process.env.NEXT_PUBLIC_PLAY_APP_URL + "/suscripcion",
    noButton: true
  },
  {
    name: "Creadorxs",
                ...
                <NavigationMenu.Item>
                  <NavigationMenu.Link asChild className="NavigationMenuLink">
                    <Link
                      ...
                      className={menu.external && !menu.noButton ? "cta-button font-serif" : ""}
                      style={{ border: menu.external && !menu.noButton ? `1px solid ${menu.color}` : "" }}
                    >
